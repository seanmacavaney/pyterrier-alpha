...
.. code-block:: python
    :caption: Building a DataFrame without :class:`~pyterrier_alpha.DataFrameBuilder`
...
:class:`~pyterrier_alpha.DataFrameBuilder` simplifies the process of building a DataFrame by removing lots of
...
.. code-block:: python
    :caption: Building a DataFrame using :class:`~pyterrier_alpha.DataFrameBuilder`
...
.. autoclass:: pyterrier_alpha.DataFrameBuilder
    :members:
